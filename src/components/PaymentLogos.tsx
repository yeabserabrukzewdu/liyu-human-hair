...
import { siStripe, siPaypal, siVisa, siMastercard, siAmericanexpress } from 'simple-icons';

// Exact Official Stripe Brand Wordmark (from Stripe Brand Kit / Press Kit)
export const StripeLogo: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  <svg
...
// Official Stripe Icon Mark (The recognizable "S" monogram)
export const StripeMark: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  <svg
    viewBox="0 0 24 24"
    fill="#635BFF"
    xmlns="http://www.w3.org/2000/svg"
...
// Exact Official PayPal Logo (Complete Double-P Monogram + Wordmark in Official Multi-Tonal Brand Palette)
export const PayPalLogo: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  <svg
    viewBox="0 0 124 33"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    />
    {/* Light Blue Front P Body */}
    <path
      fill="#179BD7"
      d="M23.048,7.667c-0.028,0.179-0.06,0.362-0.096,0.55 c-1.237,6.351-5.469,8.545-10.874,8.545H9.326c-0.661,0-1.218,0.48-1.321,1.132l0,0L6.596,26.83l-0.399,2.533 c-0.067,0.428,0.263,0.814,0.695,0.814h4.881c0.578,0,1.069-0.42,1.16-0.99l0.048-0.248l0.919-5.832l0.059-0.32 c0.09-0.572,0.582-0.992,1.16-0.992h0.73c4.729,0,8.431-1.92,9.513-7.476c0.452-2.321,0.218-4.259-0.978-5.622 C24.022,8.286,23.573,7.945,23.048,7.667z"
    />
    {/* Deep Overlay Shadow where Ps Intersect */}
    <path
      fill="#222D65"
    ...
    />
    {/* Wordmark: Pal (Light Blue #179BD7) */}
    <path
      fill="#179BD7"
...
// Official Standalone PayPal "PP" Monogram Mark
export const PayPalMark: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  <svg
    viewBox="0 0 24 24"
    fill="#002991"
    xmlns="http://www.w3.org/2000/svg"
...
// Official Visa Logo (using simple-icons official vector)
...
// Official Mastercard Logo (Dual intersecting circles)
export const MastercardLogo: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  ...
  >
    ...
    <circle cx="25" cy="12" r="8" fill="#F79E1B" fillOpacity="0.95" />
    <path
      d="M19 6.64A7.96 7.96 0 0 1 22.06 12 7.96 7.96 0 0 1 19 17.36 7.96 7.96 0 0 1 15.94 12 7.96 7.96 0 0 1 19 6.64Z"
      fill="#FF5F00"
    />
  </svg>
);

// Official American Express Logo
export const AmexLogo: React.FC<{ className?: string }> = ({ className = "h-5 w-auto" }) => (
  <svg
    viewBox="0 0 24 24"
    fill="#006FCF"
    xmlns="http://www.w3.org/2000/svg"
...
// Grouped Credit Cards Strip
export const AcceptedCardLogos: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`flex items-center gap-1.5 ${className}`}>
    <div className="h-6 px-1.5 bg-white rounded border border-[#DDD5C7] flex items-center justify-center shadow-2xs">
